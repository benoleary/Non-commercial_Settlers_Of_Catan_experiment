...
export class ConsoleInterface {
    ...
    convertToHexCorner(playerInput: string): HexCornerDirection | undefined {
        const uppercaseInput = playerInput.toUpperCase();
        const validInputs =
            ConsoleInterface.validCornerDirections.filter(
    ...
    convertToHexToHex(playerInput: string): HexToHexDirection | undefined {
        const uppercaseInput = playerInput.toUpperCase();
        const validInputs =
            ConsoleInterface.validHexToHexDirections.filter(
                validDirection => validDirection == uppercaseInput
            );
